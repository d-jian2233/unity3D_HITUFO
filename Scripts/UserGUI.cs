...
public class UserGUI : MonoBehaviour{
	...
	void OnGUI (){
        ...
        if (game_start){
            ...
            //显示当前血量
            for (int i = 0; i < life; i++) GUI.Label(new Rect(Screen.width - 105 + 10 * i, 5, 50, 50), "O", bold_style);
            ...
            GUI.Label(new Rect(Screen.width / 2 - 5, Screen.width / 2 - 350, 100, 100), "HIT UFO", over_style);
